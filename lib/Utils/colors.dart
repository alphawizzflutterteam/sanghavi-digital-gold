...
class MyColorName {
  static const Color primaryLite = Color(0xff00B1C1);
  static const Color primaryDark = Color(0xffFDE869);
  static const Color appbarBg =  Color(0xffE0BE41);
  ...
  static const Color colorTextFour = Color(0xff24745E);
  static const Color colorEdit = Color(0xfffafafa);
  static const Color colorView = Color(0xff554747);
  static const Color colorIcon =colors.secondary2;
