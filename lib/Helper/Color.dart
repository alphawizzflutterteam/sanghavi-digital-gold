...
extension colors on ColorScheme {
  ...
  static const Color primaryNew = Color(0xffeb3135);

  static const Color secondary = Color(0xffAFCB1F);

  static const Color fontClr = const Color(0xff222222);
  ...
  Color get lightBlack2 =>
      this.brightness == Brightness.dark ? bgColor : const Color(0xff999999);
  ...
  static const Color white1 = const Color(0xffFFFFFF);
  static const Color backGColor = Colors.white;
  static const Color white30 = Colors.white30;
  static const Color bgColor = Colors.white70;
